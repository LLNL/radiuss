...
<p style="text-align:center; margin:auto"><button id='star-sort' class="btn">Sort by ⭐️</button></p>
...
// Sort by stars
$("#star-sort").click(function() {
    result = $(".cards .card").sort(sort_by).appendTo(".cards");
})
