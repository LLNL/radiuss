...
<small>> @v-dobrev suggested an alternative approach, where the workspace/"arena allocator" is available as a `MemoryType`. This would have some advantages (for example, other data structures, such as arrays or matrices, could be allocated in the workspace)....</small>
