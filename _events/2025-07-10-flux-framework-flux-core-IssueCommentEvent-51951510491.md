...
<small>Re-pushed, going w/ this default output.  It's admittedly hand created.  I ponder if remaking `flux content` in python would allow us to go with the output format support in all of the other tools.  But that is perhaps for another day....</small>
