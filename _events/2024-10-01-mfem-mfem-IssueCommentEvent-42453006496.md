...
<small>> I might be wrong here but I think this implementation of the Godunov Riemann solver is valid only for scalar conservation laws. For the Euler equations in ex18 you'd need an exact Godunov-type Riemann solver....</small>
